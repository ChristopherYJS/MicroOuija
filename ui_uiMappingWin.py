...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.lineEdit_xp_tab3.sizePolicy().hasHeightForWidth())
        self.lineEdit_xp_tab3.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.lineEdit_yp_tab3.sizePolicy().hasHeightForWidth())
        self.lineEdit_yp_tab3.setSizePolicy(sizePolicy2)
        ...
        self.label_s2r_tab3 = QLabel(self.tab3)
        self.label_s2r_tab3.setObjectName(u"label_s2r_tab3")
        sizePolicy.setHeightForWidth(self.label_s2r_tab3.sizePolicy().hasHeightForWidth())
        self.label_s2r_tab3.setSizePolicy(sizePolicy)

        self.horizontalLayout_19.addWidget(self.label_s2r_tab3)

        self.horizontalLayout_20 = QHBoxLayout()
        self.horizontalLayout_20.setObjectName(u"horizontalLayout_20")
        self.lineEdit_ef_tab3 = QLineEdit(self.tab3)
        self.lineEdit_ef_tab3.setObjectName(u"lineEdit_ef_tab3")
        sizePolicy2.setHeightForWidth(self.lineEdit_ef_tab3.sizePolicy().hasHeightForWidth())
        self.lineEdit_ef_tab3.setSizePolicy(sizePolicy2)
        ...
        self.label_ef_tab3_2 = QLabel(self.tab3)
        self.label_ef_tab3_2.setObjectName(u"label_ef_tab3_2")
        sizePolicy.setHeightForWidth(self.label_ef_tab3_2.sizePolicy().hasHeightForWidth())
        self.label_ef_tab3_2.setSizePolicy(sizePolicy)

        self.horizontalLayout.addWidget(self.label_ef_tab3_2)

        self.lineEdit_s2r_tab3 = QLineEdit(self.tab3)
        self.lineEdit_s2r_tab3.setObjectName(u"lineEdit_s2r_tab3")
        sizePolicy2.setHeightForWidth(self.lineEdit_s2r_tab3.sizePolicy().hasHeightForWidth())
        self.lineEdit_s2r_tab3.setSizePolicy(sizePolicy2)
        self.lineEdit_s2r_tab3.setFrame(False)

        self.horizontalLayout.addWidget(self.lineEdit_s2r_tab3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_s2r_tab3.setText(QCoreApplication.translate("Form", u"Experiment Folder", None))
        ...
        self.label_ef_tab3_2.setText(QCoreApplication.translate("Form", u"String to replace", None))
        self.lineEdit_s2r_tab3.setText(QCoreApplication.translate("Form", u"dis,dis", None))
        self.lineEdit_s2r_tab3.setPlaceholderText("")
